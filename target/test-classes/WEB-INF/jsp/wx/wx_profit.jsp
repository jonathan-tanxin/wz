...
<main id="mian" class="p15 pb100">
	...
	<div style="text-align: center;">
		<div>我的邀请二维码</div>
		<img src="${ctx }/wx/myQrCode" alt="" />
	</div>
	<c:forEach items="${profits }" var="p">
	<div class=" mb20 bacWhite ">
    <div class="fx h100 p10 fxAi-c">
		<i class="w90 h80 mr10" style="background:url(${p.inviteeCustomer.headImage}) no-repeat; background-size:cover;"></i>
		<ul class="fxFl1">
            <li class="f24 fx fxJc-sb"><span >${p.inviteeCustomer.nickName }</span><span>购买金额：<em>${p.pay.actualPayAmount }</em></span></li>
		</ul>
	</div>
...
<div class="hw-overlayMain">
	   ...
	   <ul>
	    <li class="fx fxJc-sb f18">${profitSet.profitDesc }</li>
