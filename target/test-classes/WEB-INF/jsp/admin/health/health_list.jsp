            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                    	<form role="form" class="form-inline" id="query-form" method="post" action="${ctx }/admin/health/list" >
                    		<!-- 查询开始 -->
						...
						<div>
							<p>
								<sec:authorize ifAnyGranted="health">
						...
						<table id="table" data-toggle="table" data-height="400" data-click-to-select="true" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="xhdb">血红蛋白</th>
                                            <th data-field="xzg">血常规</th>
                                            <th data-field="date">采集时间</th>
							...
							<tbody>
								...
								<tr data-index="${idx.index }">
									...
									<td style="">${n.xzg }</td>
									<td style="">
										<fmt:formatDate value="${n.date }" pattern="yyyy-MM-dd"/>
									</td>
									<td style="">
...
function add() {
		layer.open({
		    ...
		    content: "${ctx}/admin/health/detail",
		    btn: ['确定', '取消'],
...
function edit() {
	...
	layer.open({
	    ...
	    skin: 'layui-layer-rim', //加上边框
	    area: [layer_default_width, layer_default_height], //宽高
	    content: "${ctx}/admin/health/detail?id=" + id,
	    btn: ['确定', '取消'],
	    yes: function(index, layero){ //或者使用btn1
	    	var detailForm = layer.getChildFrame('form', index);
	    	console.log(detailForm);
