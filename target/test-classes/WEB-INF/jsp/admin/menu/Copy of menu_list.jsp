						...
						<table id="table" data-toggle="table" data-height="400" data-click-to-select="true" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="rel">rel</th>
                                            <th data-field="parent">父级菜单</th>
                                            <th data-field="authority">权限</th>
                                            <th data-field="seq">顺序</th>
                                            <th data-field="show">是否显示</th>
                                        </tr>
                                    </thead>
							<tbody>
								...
								<tr data-index="${idx.index }">
									...
									<td style="">${n.href }</td>
									<td style="">${n.rel }</td>
									<td style="">${n.parent.name}</td>
									<td style="">${n.authority.name}</td>
									<td style="">${n.seq }</td>
									<td style="">${n.show }</td>
								</tr>
								</c:forEach>
