    ...
    <div class="wrapper wrapper-content animated fadeInRight">
		<form action="${ctx }/admin/dish/save?id=${n.id }" id="detail-form" class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
                 ...
                 <div class="col-sm-10">
                 	<input  name="listImage" id="listImage" value="${n.listImage }" type="hidden"/>
                 	<div class="my-images" single="true" images="${n.listImage }" name="listImageDiv" id="listImageDiv" field="listImage"></div>
                 </div>
             </div>	
			<div class="form-group">
                 <label class="col-sm-2 control-label">图片(多图)</label>
                 <div class="col-sm-10">
                 	<input  name="images" id="images" value="${n.images }" type="hidden"/>
                 	<div class="my-images" single="false" images="${n.images }" name="imagesDiv" id="imagesDiv" field="images"></div>
                 </div>
             </div>	
			<div class="form-group">
            ...
            <div class="form-group">
                 ...
                 <div class="col-sm-10">
                 	<input type="text" class="form-control" id="dishDesc" name="dishDesc" value="${n.dishDesc }" >
                 </div>
             </div>	
		</form>
</div>
...
$(document).ready(function(){
	init_images('listImageDiv');
	init_images('imagesDiv');
