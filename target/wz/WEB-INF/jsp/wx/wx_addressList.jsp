...
<main id="mian" class=" pb100">
    ...
    <ul class="fxFl1 lh36">
    	<li class="fx fxJc-sb"><span>小刀</span><span>${address.mobile }</span></li>
        <li class="fx fxJc-sb"><span>收货地址：${address.address }</span></li>
        <li class="fx fxJc-sb"><span>配送中心：${address.distributionCenter.name }</span><span>联系电话：${address.mobile }</span></li>  
    </ul>
