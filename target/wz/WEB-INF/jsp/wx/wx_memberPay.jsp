...
<main id="mian" class=" pb100">
    ...
    <ul class="fxFl1 lh36">
    	<li class="fx fxJc-sb lh48 bbt p5 mb20"><span>商品名称</span><span>开通${card.name }会员</span></li>
    	<li class="fx fxJc-sb lh48 bbt p5 mb20"><span>支付金额</span><span>${card.money }元</span></li>
    </ul>
	</div>
...
<script>
function pay() {
	alert('当前为测试阶段，开通会员只是测试会员，不会进行真正配送')
	...
	/* wx.chooseWXPay({
	    ...
	    success: function (res) {
	    	alert('success')
	        // 支付成功后的回调函数
	        location="${ctx}/wx/paySuccess?prepayId=${prepayId}";
	    }
	}); */
