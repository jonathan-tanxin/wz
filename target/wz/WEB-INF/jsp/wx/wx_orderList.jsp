...
<main id="main" class=" pb100">
    ...
    <ul class="fxFl1 lh48 bbt p15 bacWhite">
    	...
    	<li class="fx fxJc-sb" v-if="o.buyWater > 0"><span>购菜</span><span>{{o.buyWater}}斤</span><span>剩余可购买：<em>{{o.waterLeft}}桶</em></span></li>
        <li class="fx fxJc-sb"><span>{{o.createTime}}</span>
