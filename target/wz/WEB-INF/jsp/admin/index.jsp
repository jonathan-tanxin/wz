                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="http://n5.image.pg0.cn/T1dEDHB_KO1RCvBVdK.jpg" width="80" /></span>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<!-- 
                            <li>
                                <a class="J_menuItem" href="${ctx}/admin/index/index_v3" data-index="0">主页示例一</a>
                            </li>
                             -->
                            <c:forEach items="${level1Menu.children }" var="level2Menu">
                            	<c:if test="${level2Menu.show }">
                            <li>
                                <a class="J_menuItem" href="${ctx }/${level2Menu.href}">${level2Menu.name }</a>
                            </li>
                            	</c:if>
                            </c:forEach>
                        </ul>
...
<%--                                             <img alt="image" class="img-circle" src="${ctx }/res/hplus/img/a7.jpg"> --%>
<!--                                         </a> -->
...
<!--                                     <div class="dropdown-messages-box"> -->
<!--                                         <a href="profile.html" class="pull-left"> -->
<%--                                             <img alt="image" class="img-circle" src="${ctx }/res/hplus/img/a4.jpg"> --%>
<!--                                         </a> -->
<!--                                         <div class="media-body "> -->
...
<!--                         </li> -->
<!--                         <li class="hidden-xs"> -->
<%--                             <a href="${ctx}/admin/index/index_v3" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a> --%>
<!--                         </li> -->
                        <li class="dropdown hidden-xs">
                            <a class="right-sidebar-toggle" aria-expanded="false" onclick="location='${ctx}'">
                                <i class="fa fa-tasks"></i> 返回商城
                            </a>
                        </li>
                    </ul>
                </nav>
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${ctx }/res/hplus/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${ctx }/res/hplus/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${ctx }/res/hplus/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${ctx }/res/hplus/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${ctx }/res/hplus/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${ctx }/res/hplus/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="${ctx }/res/hplus/js/plugins/layer/layer.min.js"></script>
    <script src="${ctx }/res/hplus/js/hplus.min.js?v=4.0.0"></script>
    <script type="text/javascript" src="${ctx }/res/hplus/js/contabs.min.js"></script>
    <script src="${ctx }/res/hplus/js/plugins/pace/pace.min.js"></script>
