    ...
    <div class="wrapper wrapper-content animated fadeInRight">
		<form action="${ctx }/admin/customer/save?id=${n.id }" id="detail-form" class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
                 ...
                 <div class="col-sm-10">
                 	<input type="radio"  checked="true" value="true" name="isDishMember"> <i></i> 是</label>
                 	<input type="radio"  value="false" name="isDishMember"> <i></i> 否</label>
                 </div>
             </div>	
			<div class="form-group">
                 <label class="col-sm-2 control-label">桶装水会员</label>
                 <div class="col-sm-10">
                 	<input type="radio"  checked="true" value="true" name="isWaterMember"> <i></i> 是</label>
                 	<input type="radio"  value="false" name="isWaterMember"> <i></i> 否</label>
                 </div>
             </div>	
			<div class="form-group">
