            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                    	<form role="form" class="form-inline" id="query-form" method="post" action="${ctx }/admin/province/list" >
                    		<!-- 查询开始 -->
                            ...
                            <div class="form-group">
                                <label for="query-isHot" class="sr-only">是否是热门城市</label>
                                	<input type="text" placeholder="是否是热门城市" id="query-isHot" name="isHot" value="${query.isHot }" class="form-control">
                            </div>
                            <div class="form-group">
...
function add() {
		layer.open({
		    ...
		    content: "${ctx}/admin/province/detail",
		    btn: ['确定', '取消'],
...
function edit() {
	...
	layer.open({
	    ...
	    skin: 'layui-layer-rim', //加上边框
	    area: [layer_default_width, layer_default_height], //宽高
	    content: "${ctx}/admin/province/detail?id=" + id,
	    btn: ['确定', '取消'],
	    yes: function(index, layero){ //或者使用btn1
	    	var detailForm = layer.getChildFrame('form', index);
	    	console.log(detailForm);
