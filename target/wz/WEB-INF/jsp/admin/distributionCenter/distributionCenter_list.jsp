                    ...
                    <div class="ibox-content">
                    	<form role="form" class="form-inline" id="query-form" method="post" action="${ctx }/admin/distributionCenter/list" >
                            ...
                            <div class="form-group">
                                <label for="query-customer" class="sr-only">关联负责人</label>
                                	<input type="text" placeholder="关联负责人" id="query-customer" name="customer.nickName" value="${query.customer.nickName }" class="form-control">
                            </div>
                            <div class="form-group">
						...
						<table id="table" data-toggle="table" data-height="400" data-click-to-select="true" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="customer.nickName">关联负责人</th>
