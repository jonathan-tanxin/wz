...
<main id="mian" class="p15 pb100">
    ...
    <div class="fx fxJc-sa f24">
    	...
    	<ul class="lh36 fxFl1 tc p15"><li>山泉水剩余可购</li>
    	<li>
    		<c:if test="${customer.waterLeft > 0 }">
    		<em class="f32 tc-gules mr20">${customer.waterLeft }</em>件
    		</c:if>
    		<c:if test="${customer.waterLeft <= 0 }">
...
<section class="p30 fx bbt fxAi-c" onclick="location='${ctx }/wx/profit'"><span class="fxFl1">邀请会员</span><i class="fa fa-angle-right fa-2x"></i></section>
...
<section class="p30 fx bbt fxAi-c" onclick="location='${ctx }/wx/myHealth'"><span class="fxFl1">我的健康指导</span><span class="f24 mr5">获的专家1V1的指导</span><i class="fa fa-angle-right fa-2x"></i></section>
</div>
