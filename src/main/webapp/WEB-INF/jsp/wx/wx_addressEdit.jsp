...
<span class="w100 mr50">收货人</span><form class="fonGray">
	<input type="text" id="name" placeholder="请输入您的收货姓名" value="${n.name }" class="bt-no f28 p10 lh32"></form>
</section>
<section class="p30 fx bbt fxAi-c">
<span class="w100 mr50">联系电话</span><form class="fonGray">
<input type="text" id="mobile" placeholder="请输入手机号码" value="${n.mobile }" class="bt-no f28 p10 lh32"></form>
</section>
<section class="p30 fx bbt fxAi-c">
<span class="w100 mr50">地区</span><form class="fonGray">
...
<section class="p30 fx bbt fxAi-c">
<span class="w100 mr50">详细地址</span><form class="fonGray"><input value="${n.address }" id="address" placeholder="请输入详细的收货地址" type="text" class="bt-no f28 p10 lh32"></form>
</section>
<section class="p30 fx bbt fxAi-c">
<span class="w100 mr50">配送中心</span><form class="fonGray">
<select name="select" id="center" class="bt-no f28 p10 lh32">
	<option value="${n.distributionCenter.id }">${n.distributionCenter.name }</option>
</select></form>
</section>
</div>
...
$('#province').change(function() {
	...
	$('#center').html('');
	$('#center').append('<option value="">选择配送中心</option>');
	if (provinceId != '') {
		$.ajax({
...
$('#district').change(function() {
	...
	$('#center').append('<option value="">选择配送中心</option>');
	$.ajax({
		url: "${ctx}/wx/getCenters?districtId=" + districtId + "&&cityId=" + cityId,
		dataType: 'json',
