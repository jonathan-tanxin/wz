...
<main id="mian" class="p15 pb100">
    ...
    <i class="w100 h100" style="background:url(${address.distributionCenter.customer.headImage}) no-repeat; background-size:cover;"></i>
    <p class="w  tc lh42">${address.distributionCenter.customer.nickName }</p>
    </div>
    <div class="fx fxJc-sa bbt">
    	<ul class="lh36 tc fxFl1 brt p15"><li>联系人</li><li><a class="tc-gules">${address.distributionCenter.leader }</a></li></ul>
    	<ul class="lh36 fxFl1 tc p15"><li>联系电话</li><li><a class="tc-gules">${address.distributionCenter.mobile }</a></li></ul>
    </div>
...
<section class="p30 fx  fxAi-c" onclick="location='${ctx }/wx/orderList'">
	<span class="fxFl1">配送情况</span><i class="fa fa-angle-right fa-2x"></i>
</section>
</div>
